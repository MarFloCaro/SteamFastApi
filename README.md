...
Nuevamente, el detalle de este proceso puede seguirse paso a paso en [eda.ipynb](/entregables/eda.ipynb). Algunos puntos a destacar son:
...
+ Creación de una nueva columna para hacer observaciones de tiempo según la edad del release en meses y observación comportamiento nueva columna respecto al precio
...
+ Nueva matriz de correlación para ver la fuerza de la edad del release.
...
### 1. Exploración y Entrenamiento de Modelos
<hr>
...
+ Por los modelos con menos error
...
* Predecimos para los modelos de mejor rendimiento/mejor ajuste.
